...
class UtilisateurAdmin(admin.ModelAdmin):
    list_display = ["first_name","last_name","profil","date_naissance","cni","address","type","phone","fonction","symboles_cibles","entreprise","qrTag","nfcTag"]
    list_editable = ["first_name","last_name","profil","date_naissance","cni","address","type","phone","fonction","symboles_cibles","entreprise","qrTag","nfcTag"]
